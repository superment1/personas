...
<template>
  <section class="w-full bg-[#370F1E] flex flex-col items-center justify-start pt-0 pb-5">
    ...
    <div class="flex flex-col gap-0  md:gap-[3rem] lg:gap-[2.5rem] md:flex-row w-full justify-center items-center md:items-start">
      <!-- Explore -->
      <div class="w-full max-w-[330px] py-8 text-white flex flex-col items-start justify-center" >
        <h2 class="text-4xl font-normal font-crossfit uppercase mb-6 w-full text-left">Explore</h2>
        <ul class="space-y-1 text-[#FFFAF0] font-dmsans text-[18px]">
          ...
          >
            ...
            >
              ...
              <span class="w-6 h-6 transition-transform duration-200 group-hover:translate-x-1">
                <svg
    ...
    <div class="flex flex-col items-center mt-6">
      ...
      <p class="text-[#FFFAF0] font-dmsans font-extralight text-[9px] leading-[12px] text-justify mt-6 w-[330px] md:w-[700px]">
