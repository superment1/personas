            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 lg:gap-8 mb-6 lg:mb-4">
                <div class="flex items-center w-[330px] py-2 border-b last:border-b-0 lg:flex-col lg:border-b-0 "
                    ...
                    <div class="text-left lg:text-center flex justify-center items-center">
                        <div class="mt-2">
                            <h3 class="text-[#525252] text-[20px] leading-[1.1] lg:text-xl font-light">Passionflower</h3>
                            <p class="text-gray-600 pl-[4px] text-[16px] lg:text-base font-light">Quiets the mind.</p>
                        </div>
                    </div>
                </div>

                <div class="flex items-center w-[330px] border-b lg:flex-col lg:border-b-0"
                    style="border-color: #FFE1AA">
                    <div class="w-[full] h-[full] lg:w-24 lg:h-24 flex items-center justify-center mr-6 flex-shrink-0 lg:mb-3 lg:mr-0">
                    ...
                    <div class="text-left lg:text-center flex justify-center items-center">
                        <div class="mt-2">
                            <h3 class="text-[#525252] text-[20px] leading-[1.1] lg:text-xl font-light">Corydalis</h3>
                            <p class="text-gray-600 pl-[4px] text-[16px] lg:text-base font-light">Eases tension.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center w-[330px] border-b lg:flex-col lg:border-b-0"
                    ...
                    <div class="text-left lg:text-center flex justify-center items-center">
                        <div class="mt-2">
                            <h3 class="text-[#525252] text-[20px] leading-[1.1] lg:text-xl font-light">Marshmallow Root</h3>
                            <p class="text-gray-600 pl-[4px] text-[16px] lg:text-base font-light">Soothes digestion.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center w-[330px] border-b lg:flex-col lg:border-b-0"
                    ...
                    <div class="text-left lg:text-center flex justify-center items-center">
                        <div class="mt-2">
                            <h3 class="text-[#525252] text-[20px] leading-[1.1] lg:text-xl font-light">California Poppy</h3>
                            <p class="text-gray-600 pl-[4px] text-[16px] lg:text-base font-light">Relaxes the body.</p>
                        </div>
                    </div>
                </div>

                <div class="flex items-center w-[330px] border-b pb-2 lg:flex-col lg:border-b-0"
                    style="border-color: #FFE1AA">
                    <div class="w-[full] h-[full] lg:w-24 lg:h-24 flex items-center justify-center mr-6 flex-shrink-0 lg:mb-3 lg:mr-0">
                    ...
                    <div class="text-left lg:text-center flex justify-center items-center">
                        <div class="mt-2">
                            <h3 class="text-[#525252] text-[20px] leading-[1.1] lg:text-xl font-light">Prickly Pear</h3>
                            <p class="text-gray-600 pl-[4px] text-[16px]text-sm lg:text-base font-light">Keeps sleep steady.</p>
                        </div>
                    </div>
                </div>
            </div>
