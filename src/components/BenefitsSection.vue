<template>
    ...
    <section class="py-4 lg:py-12">
        <div class="max-w-7xl lg:max-w-5xl mx-auto mb-8 px-4">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-6 mx-8">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-[#525252] leading-[1.1] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-[#525252] text-sm leading-[1.1] lg:text-lg font-light">
