<template>
    ...
    <section class="py-4 lg:py-12">
        <div class="max-w-7xl lg:max-w-5xl mx-auto px-4">
            <h2 class="font-gelasio text-2xl lg:text-4xl text-[#525252] text-left lg:text-center mb-8 lg:mb-12 italic mx-8">
                What happens when you sleep naturally:
            </h2>
            <div class="grid grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 mx-8">
                <!-- Benefits Grid -->
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    ...
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Collagen</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    <img src="@/assets/image/sleepWomam/hydration.png" alt="Hydration"
                        class="w-[150px] h-[150px] lg:w-[290px] lg:h-[160px] rounded-xl object-cover flex-shrink-0" />
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Hydration</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    <img src="@/assets/image/sleepWomam/cell-regeneration.png" alt="Cell Regeneration"
                        class="w-[150px] h-[150px] lg:w-[290px] lg:h-[160px] rounded-xl object-cover flex-shrink-0" />
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Cell Regeneration</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    <img src="@/assets/image/sleepWomam/even-skin-tone.png" alt="Even Skin Tone"
                        class="w-[150px] h-[150px] lg:w-[290px] lg:h-[160px] rounded-xl object-cover flex-shrink-0" />
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Even Skin Tone</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    <img src="@/assets/image/sleepWomam/stress-reduction.png" alt="Stress Reduction"
                        class="w-[150px] h-[150px] lg:w-[290px] lg:h-[160px] rounded-xl object-cover flex-shrink-0" />
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Stress Reduction</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
                ...
                <div class="flex flex-col items-center gap-4 lg:items-start">
                    <img src="@/assets/image/sleepWomam/glymphatic-detox.png" alt="Glymphatic Detox"
                        class="w-[150px] h-[150px] lg:w-[290px] lg:h-[160px] rounded-xl object-cover flex-shrink-0" />
                    <div class="text-left">
                        <h3 class="font-light text-lg lg:text-2xl text-[#525252] mb-1">Glymphatic Detox</h3>
                        <p class="text-[#525252] text-sm lg:text-lg font-light">
