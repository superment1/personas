  ...
  <section class="flex flex-col justify-end items-end py-0 bg-[##6EC8F0]">
    <div class="flex flex-col items-start justify-center w-[160px] sm:w-[220px] gap-2 xl:gap-4">
      <div class="flex flex-row items-center gap-[3px] w-full xl:w-[410px]">
        <svg class="block sm:hidden" xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21"
          fill="none">
          <path
        ...
        <svg class="hidden sm:block xl:hidden" xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 49 50"
          fill="none">
          <path
        ...
        <span class="text-[#370F13] font-crossfit text-[18px] sm:text-[24px] xl:text-[46px] font-black leading-[106%] text-center">
          LIMITED TIME OFFER
        </span>
      </div>
      ...
      <div class="w-[160px] flex flex-row items-center justify-between xl:gap-4 sm:w-[220px]">
        ...
        <div class="flex flex-col gap-2">
          <div
            class="card relative overflow-hidden xl:text-[143px] text-[56px] sm:text-[82px] font-crossfit isolate rounded-[19px]
