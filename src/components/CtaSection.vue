                ...
                <div class="block md:hidden w-[330px]">
                    ...
                    <div class="text-white text-md pt-36">
                        <div class="flex items-center justify-start  py-2">
                            ...
                            <span class="ml-2">30-day satisfaction guarantee</span>
                        </div>
                    ...
                    <div class="relative">
                        <div class="relative">
                            <div class="absolute right-12 -top-52 lg:right-4 lg:-top-56">
                                <img src="@/assets/image/sleepWomam/price-desk-thin.png" alt="Pricing" class="h-58 lg:h-50" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-left w-[380px]">
                        ...
                        <div class="space-y-1 mb-8 text-white text-lg">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="font-DMSans text-[16px] font-regular">Clean-label, clinically guided formulation</span>
                            </div>
                            <div class="flex items-center">
                                ...
                                <span class="font-DMSans text-[16px] font-regular leading-[1.2]">Trusted U.S. manufacturing, under FDA and GMP certification</span>
                            </div>
                            <div class="flex items-center">
                                <svg width="22" height="21" viewBox="0 0 22 21" class="w-6 h-6 mr-3" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-DMSans text-[16px] font-regular">Limited-time bundle pricing available</span>
                            </div>
                        </div>
                        <ShopButton
                            id="buy-button"
