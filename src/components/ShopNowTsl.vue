        ...
        <div class="lg:max-w-[814px] max-w-[331px] ">
                ...
                <div
                    ...
                    <div class="relative h-[385px]">
                        ...
                        productId="prod_SbKa8ag01A2TGX"
                            ...
                            <div class="flex flex-row items-center justify-center gap-3">                        
                                <span class="font-DMSans text-[17px] md:text-[20px] leading-[1.2] font-bold text-[#370F1E]">
                                    3 Bottles: Our most popular option <br>steady support for months of<br> deep rest.
                                </span>
                            </div>
                        </ShopButton>     
                    </div>                                
                ...
                <div
                    ...
                    <div class="relative h-[365px]">
                        ...
                        productId="prod_SbKaRuJpDVBEzx"
                            ...
                            <div class="flex flex-row items-center justify-center gap-3">                        
                                <span class="font-DMSans text-[17px] md:text-[20px] leading-[1.2] font-bold text-[#370F1E]">
                                    6 Bottles: The best value, ensuring <br>you never run out of calm nights.
                                </span>
                            </div>
                        </ShopButton>     
                    </div>                               
            ...
            <div class="text-center text-[12px] justify-items-center">
                <div
                    ...
                    <p class="hidden lg:block leading-[1] text-[#370F1E] lg:text-[24px] pb-[15px] pt-[28px]">And to make your choice completely risk-free, every order is protected<br> by our up<span class="font-bold"> to 120-day, money-back guarantee.</span>
                        <br><br> Try Super Natural Sleep. If you don’t feel the difference — if your nights<br> aren’t calmer, if your mornings aren’t brighter — just send the unopened<br> bottles back. You’ll receive a refund for them.</p>
                    <p class="font-gelasio italic pb-[30px] text-[#370F1E] text-[16px] lg:text-[32px]">That’s how confident we are in this formula.</p>
                    <ShopButton 
                    textColorClass=" text-[#370F1E]" 
                    iconColorClass="text-[#370F1E]" 
                    :show-icon="true"
                    :anchorId="anchorId" 
                    class="flex flex-row w-full lg:w-[631px] items-center bg-[#FFDC03] !h-[40px] lg:!h-[73px] px-[20px] py-[7px] text-[14px] lg:text-[25px] font-bold rounded-full justify-center gap-3"
                    >
                        Rest Easy. Your Journey Is Risk-Free
                    </ShopButton>
                    <div class="flex justify-center md:justify-start lg:justify-center">
                        <div class="w-[270px] md:w-[540px] lg:w-[500px] gap-[11px] lg:mt-8 mt-[12px] flex flex-row justify-betwween md:justify-start justify-between">
