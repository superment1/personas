...
<template>
    <div class="bg-[#C7AF7F] w-full flex flex-col items-center py-7 gap-y-2 lg:py-[84px]">
        <p
            class="hidden lg:block text-[#222C39] lg:!pl-0 whitespace-pre-line w-[320px] lg:w-[920px] font-crossfit font-bold leading-[1.08] text-[32px] md:text-[46px] lg:text-[50px]">
            {{ props.primary }}
        </p>
        <p
            class="lg:hidden text-[#222C39] text-center lg:!pl-0 whitespace-pre-line w-[320px] lg:w-[920px] font-crossfit font-bold leading-[1.08] text-[32px] md:text-[46px] lg:text-[50px]">
            {{ props.primary }}
        </p>
        <div class="w-[320px] lg:w-[920px] ">   
            <p class="text-[#222C39] text-center font-gelasio font-semibold text-[15px] md:text-[22px] lg:text-[30px]">
                {{ props.subtitle }}
            </p>
        </div>
        ...
        <div ref="track" class="w-full max-w-[1150px] mt-[10px] md:mt-[25px] lg:mt-[45px] px-4 flex gap-2 md:gap-10 lg:gap-20 overflow-x-auto scroll-smooth
            ...
            <div v-for="(t, i) in testimonials" :key="i" :ref="el => (itemEls[i] = el)"
                ...
                <div class="shrink-0 w-[301px] md:w-[640px] h-[219px] md:h-[280px] lg:w-[920px] lg:h-[480px] justify-between snap-center bg-[#FFFAF0] rounded-xl 
                    ...
                    <p class="text-[#222C39] font-crossfit font-bold text-[17px] lg:text-[52px] leading-[1.2]">{{
                        t.title }}
                    </p>
                    <p
                        class="text-[#222C39] font-DMSans font-regular text-[12px] lg:text-[26px] leading-[1.15] lg:mt-[14px]">
                        {{ t.testimonial }}</p>
                    <div class="flex flex-row items-start justify-start mt-2 lg:mt-[16px]">
                        ...
                        <div class="flex flex-col items-start justify-center ml-3 pt-1">
                            <p
                                class="text-[#222C39] font-gelasio font-bold italic text-[14px] md:text-[24px] lg:text-[34px] leading-[0.96]">
                                {{ t.name }}</p>
                            <p
                                class="text-[#222C39] font-gelasio font-regular italic text-[13px] md:text-[22px] lg:text-[32px] leading-[1.15] mt-[2px]">
                                {{ t.city }}</p>
