...
async function onPrimary(e: MouseEvent) {
    ...
    <transition name="fade">
      ...
      >
        ...
        <div class="flex items-center gap-3">
          <svg class="self-start sm:w-auto w-[28px] relative top-0"  xmlns="http://www.w3.org/2000/svg" width="59" height="61" viewBox="0 0 59 61" fill="none">
