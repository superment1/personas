        ...
        <div
            ...
            <div class="w-full flex flex-col items-center gap-[12px] lg:w-[550px] lg:h-[550px]">
                ...
                <span
                    ...
                    mental chatter and <br class="hidden lg:block">
            ...
            <div class="w-full flex flex-col items-center gap-[12px] lg:w-[550px] lg:h-[550px] lg:pt-[80px]">
                ...
                <span
                    ...
                    transitions <br class="hidden lg:block">into sleep.</span>
            </div>
            <div class="w-full flex flex-col items-center gap-[12px] lg:w-[550px] lg:h-[550px] lg:pt-[80px]">
                ...
                <span
                    ...
                    overnight <br class="hidden lg:block">inflammation <br>and oxidative stress.</span>
            </div>
