...
// const prices = {
//   BR: { old: 'R$399', current: 'R$250' },
//   US: { old: '$60', current: '$48' },
//   CA: { old: 'C$89', current: 'C$68' },
//   UK: { old: '£50', current: '£38' },
// }
// const price = computed(() => {
//   const code = (countryCode.value ?? '').toString().trim().toUpperCase()
//   return prices[code] || prices.US
// })
// // const price = computed(() => prices[countryCode.value] || prices.US)

// watch(countryCode, (now, prev) => {
//   console.log('countryCode mudou:', prev, '→', now)
// }, { immediate: true })
        ...
        <div class="w-full flex flex-col items-center justify-center">
          ...
          <ShopButton type="button" id="buy-button" :anchorId="anchorId" :showIcon="false"
            ...
            <div
              ...
              before:-translate-y-1/2 before:rotate-[25deg] before:rounded-full">£50</span>
              <span class="text-[#FFDC03]">£38</span><span class="text-[#FFDC03]">|</span><span class="text-[#FFDC03]">SHOP NOW</span>
            </div>
      ...
      <div class="button relative bottom-[110px]">
        ...
        <ShopButton type="button" id="buy-button" :anchorId="anchorId" :showIcon="false"
          ...
          <div class="bg-[#370F1E] text-[24px] gap-1 flex items-center transition-transform duration-300 hover:scale-110 justify-center rounded-md w-[220px] font-crossfit h-[48px]">
            ...
            before:content-[''] before:absolute before:-left-1 before:-right-1
            before:top-1/2 before:h-[1px] before:bg-[#1E010C]
            before:-translate-y-1/2 before:rotate-[25deg] before:rounded-full">£50</span><span
              class="text-[#FFDC03]">£38</span><span class="text-[#FFDC03]">|</span><span class="text-[#FFDC03]">SHOP NOW</span>
          </div>
        </ShopButton>
