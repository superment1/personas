        ...
        <div class="w-full flex flex-col items-center justify-center">
          ...
          <ShopButton type="button" id="buy-button" :anchorId="anchorId" :showIcon="false"
            ...
            <div
              ...
              before:-translate-y-1/2 before:rotate-[25deg] before:rounded-full">C$89</span><span
                class="text-[#FFDC03]">C$68</span><span class="text-[#FFDC03]">|</span><span class="text-[#FFDC03]">SHOP NOW</span>
            </div>
