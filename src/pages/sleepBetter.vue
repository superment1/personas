...
<template>
  <div class="w-full min-h-screen bg-white flex flex-col">
    <main>
      <section class="relative justify-items-center w-full">
        ...
        <div class="absolute py-[46px] inset-0 hidden sm:flex flex-col text-white w-[996px] justify-self-center justify-between text-start">
      ...
      <section>
        <div class="w-full bg-[#FFFAF0] flex items-center justify-center relative">
          <div class="px-[42px] sm:px-0 items-center text-[15px] md:text-[30px] max-w-[996px] font-normal text-[#370F1E] leading-[17.7px] md:leading-[35px] py-8">
            ...
            <p class="hidden sm:block">
             That night, it hit me — I wasn’t just tired. I was half-present everywhere: <br>at work, at home, even with myself.
            </p>
            ...
            <p class="pt-5">That’s when I found <span class="font-bold">Super Natural Sleep.</span><br> No melatonin. No morning fog. Just a natural way to calm the spin and sink into real, restorative sleep.
            </p>
            <p class="pt-5 block sm:hidden">The first night, I actually stayed asleep. No 2 a.m. wake-ups, no scrolling emails in the dark. The next morning, I made pancakes for my son before school. He looked at me and said, “You’re happy today, Mom.” That one line hit harder than any performance review<br> ever could.
            </p>
            <p class="pt-5 hidden sm:block">The first night, I actually stayed asleep. No 2 a.m. wake-ups, no scrolling emails in the dark. The next morning, I made pancakes for my son before school. He looked at me and said, “You’re happy today, Mom.” <br>That one line hit harder than any performance review ever could.
            </p>
            <p class="pt-5 hidden sm:block">By the end of the week, I was walking into meetings, sharp, clear, confident. I didn’t blank. I didn’t snap.
            </p>
            <p class="pt-5 sm:hidden block">By the end of the week, I was walking into meetings, sharp, clear, confident. I didn’t blank.<br>I didn’t snap.
            </p>
    ...
    <section>
      <div class="w-full bg-[#370F1E] justify-center relative">
        ...
        <div class="px-[42px] pt-[43px] sm:hidden ">
          ...
          <div >
            ...
            <p class="text-center text-[15px] leading-[18px] pt-[15px] pb-[30px] text-[#fff]">This isn’t just data — <span class="font-semibold">  it’s your body sending <br> early warnings.</span></p>
          </div>
        </div>
        <span
          class="pointer-events-none absolute left-1/2 -translate-x-1/2 -bottom-4 translate-y-[1px] z-10
      ...
      <div class="bg-[#FFFAF0] w-full items-center lg:pb-[40px]">
        <div class="w-[349px] mx-auto lg:w-full pt-[31px] lg:pt-[90px] lg:pb-[30px] font-gelasio font-medium  italic text-center justify-self-center">
      ...
      <div class="w-full bg-[#E1DCCD] justify-items-center relative">
        <div class="px-[42px] lg:px-0 lg:py-[130px] py-[35px] lg:max-w-[996px] ">
          ...
          <p class="font-bold sm:hidden block leading-[1.2] text-[#370F1E] lg:text-center lg:text-[30px] text-[15px] pt-[18px]">
            Common side effects of conventional <br>sleep aids:
          </p>
           <p class="font-bold sm:block hidden leading-[1.2] text-[#370F1E] lg:text-center lg:text-[30px] text-[15px] pt-[18px]">
  ...
  >
    <template #message>
      <p class="text-[#fff] sm:text-[31px] text-[13px]">Get <span class="text-[#FFDC03] sm:text-[24px]">20% OFF </span> to shop now <br> — today only.>
      </p>
    </template>
  </BannerRetention>
</template>