...
import StopWatch2 from '../components/StopWatch2.vue';
...
<template>
  <section class="">
    <div class="bg-[#370F1E] flex items-center justify-center w-full h-[45px] lg:h-[80px]">
  ...
  <section id="shop-relax" class="bg-[#4DBCB6] flex flex-col items-center justify-items-center py-[29px]">
    <div class="px-[35px] justify-items-center">
      ...
      <ShopButton type="button" id="buy-button" productId="prod_T2jNgj5cCjXcvG" textColorClass="text-[#370F1E]"
        :showIcon="false"
  ...
  <div class="flex flex-col gap-3 bg-[#370F1E] p-[35px] items-center">
      <div class="leading-[1] text-[#fffaf0] text-[2rem] font-crossfit">
