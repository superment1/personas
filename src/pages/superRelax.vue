...
<template>
  ...
  <section class="firtsection bg-[#6fc8f0]">
    <div class="relative
        ...
        md:bg-[url('/assets/hero_relax.webp')]
        ">
      <div class="px-12">
        <div class="text-[#370F1E] gap-[120px] flex flex-col">       
          <p class="italic font-gelasio mt-[60px] text-[13px] leading-[15px] font-bold">A Powerfull <br>Plant-Based Formula <br><span class="font-medium">that Restores Nervous <br>System Balance.</span></p>
          <div class="font-gelasio">
            <svg xmlns="http://www.w3.org/2000/svg" width="69" height="17" viewBox="0 0 69 17" fill="none">
              <g filter="url(#filter0_d_155_121)">
                <path d="M9.1692 1.1606C9.17006 1.1606 9.17082 1.16116 9.17109 1.16198L9.70274 2.80026C10.02 3.77789 10.9308 4.43992 11.9587 4.43992H13.6819C14.2342 4.43992 14.4656 5.14841 14.0173 5.4723C12.3548 6.68125 11.6593 8.82353 12.2938 10.7788C12.4644 11.3051 11.8629 11.7418 11.4147 11.4179C9.7527 10.2093 7.50126 10.2093 5.83927 11.4179C5.39104 11.7418 4.78954 11.3051 4.96016 10.7788C5.59467 8.82353 4.89917 6.68125 3.23664 5.4723C2.78841 5.14841 3.01975 4.43992 3.57209 4.43992C5.62736 4.43992 7.44892 3.11551 8.08332 1.1606C8.25379 0.634758 8.99582 0.634292 9.1673 1.1592C9.16756 1.16002 9.16834 1.1606 9.1692 1.1606Z" fill="url(#paint0_linear_155_121)"/>
                <path d="M22.1058 1.15963C22.1066 1.15963 22.1074 1.16018 22.1077 1.161L22.6393 2.79928C22.9566 3.77692 23.8674 4.43894 24.8953 4.43894H26.6185C27.1708 4.43894 27.4021 5.14744 26.9539 5.47132C25.2914 6.68028 24.5959 8.82256 25.2304 10.7778C25.401 11.3041 24.7995 11.7408 24.3513 11.4169C22.6893 10.2083 20.4378 10.2083 18.7759 11.4169C18.3276 11.7408 17.7261 11.3041 17.8967 10.7778C18.5313 8.82256 17.8358 6.68028 16.1732 5.47132C15.725 5.14744 15.9563 4.43894 16.5087 4.43894C18.5639 4.43894 20.3855 3.11453 21.0199 1.15963C21.1904 0.633782 21.9324 0.633315 22.1039 1.15823C22.1041 1.15905 22.1049 1.15963 22.1058 1.15963Z" fill="url(#paint1_linear_155_121)"/>
                <path d="M35.0422 1.15963C35.0431 1.15963 35.0439 1.16018 35.0441 1.161L35.5758 2.79928C35.893 3.77692 36.8039 4.43894 37.8317 4.43894H39.5549C40.1073 4.43894 40.3386 5.14744 39.8904 5.47132C38.2278 6.68028 37.5323 8.82256 38.1668 10.7778C38.3375 11.3041 37.736 11.7408 37.2877 11.4169C35.6257 10.2083 33.3743 10.2083 31.7123 11.4169C31.2641 11.7408 30.6626 11.3041 30.8332 10.7778C31.4677 8.82256 30.7722 6.68028 29.1097 5.47132C28.6615 5.14744 28.8928 4.43894 29.4451 4.43894C31.5004 4.43894 33.322 3.11453 33.9564 1.15963C34.1268 0.633782 34.8689 0.633315 35.0403 1.15823C35.0406 1.15905 35.0414 1.15963 35.0422 1.15963Z" fill="url(#paint2_linear_155_121)"/>
                <path d="M47.9788 1.15963C47.9796 1.15963 47.9804 1.16018 47.9807 1.161L48.5123 2.79928C48.8296 3.77692 49.7404 4.43894 50.7682 4.43894H52.4914C53.0438 4.43894 53.2751 5.14744 52.8269 5.47132C51.1644 6.68028 50.4689 8.82256 51.1034 10.7778C51.274 11.3041 50.6725 11.7408 50.2243 11.4169C48.5623 10.2083 46.3108 10.2083 44.6488 11.4169C44.2006 11.7408 43.5991 11.3041 43.7697 10.7778C44.4042 8.82256 43.7087 6.68028 42.0462 5.47132C41.598 5.14744 41.8293 4.43894 42.3817 4.43894C44.4369 4.43894 46.2585 3.11453 46.8929 1.15963C47.0634 0.633782 47.8054 0.633315 47.9769 1.15823C47.9771 1.15905 47.9779 1.15963 47.9788 1.15963Z" fill="url(#paint3_linear_155_121)"/>
                <path d="M60.9152 1.15963C60.9161 1.15963 60.9169 1.16018 60.9171 1.161L61.4488 2.79928C61.766 3.77692 62.6769 4.43894 63.7047 4.43894H65.4279C65.9802 4.43894 66.2116 5.14744 65.7634 5.47132C64.1008 6.68028 63.4053 8.82256 64.0398 10.7778C64.2105 11.3041 63.609 11.7408 63.1607 11.4169C61.4987 10.2083 59.2473 10.2083 57.5853 11.4169C57.1371 11.7408 56.5356 11.3041 56.7062 10.7778C57.3407 8.82256 56.6452 6.68028 54.9827 5.47132C54.5344 5.14744 54.7658 4.43894 55.3181 4.43894C57.3734 4.43894 59.195 3.11453 59.8294 1.15963C59.9998 0.633782 60.7418 0.633315 60.9133 1.15823C60.9136 1.15905 60.9144 1.15963 60.9152 1.15963Z" fill="url(#paint4_linear_155_121)"/>
              </g>
              <defs>
                <filter id="filter0_d_155_121" x="0.329362" y="0.764893" width="68.3413" height="16.1052" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                ...
                <linearGradient id="paint0_linear_155_121" x1="12.423" y1="10.7174" x2="6.25383" y2="1.15136" gradientUnits="userSpaceOnUse">
                ...
                <linearGradient id="paint1_linear_155_121" x1="25.3595" y1="10.7164" x2="19.1904" y2="1.15038" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#FFE5A6"/>
                  <stop offset="0.307692" stop-color="#E49C21"/>
                  <stop offset="0.697115" stop-color="#FFE5A6"/>
                  <stop offset="1" stop-color="#E49C21"/>
                </linearGradient>
                <linearGradient id="paint2_linear_155_121" x1="38.296" y1="10.7164" x2="32.1269" y2="1.15038" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#FFE5A6"/>
                  <stop offset="0.307692" stop-color="#E49C21"/>
                  <stop offset="0.697115" stop-color="#FFE5A6"/>
                  <stop offset="1" stop-color="#E49C21"/>
                </linearGradient>
                <linearGradient id="paint3_linear_155_121" x1="51.2325" y1="10.7164" x2="45.0634" y2="1.15038" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#FFE5A6"/>
                  <stop offset="0.307692" stop-color="#E49C21"/>
                  <stop offset="0.697115" stop-color="#FFE5A6"/>
                  <stop offset="1" stop-color="#E49C21"/>
                </linearGradient>
                <linearGradient id="paint4_linear_155_121" x1="64.169" y1="10.7164" x2="57.9999" y2="1.15038" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#FFE5A6"/>
                  <stop offset="0.307692" stop-color="#E49C21"/>
                  <stop offset="0.697115" stop-color="#FFE5A6"/>
                  <stop offset="1" stop-color="#E49C21"/>
            ...
            <p class="text-[13px] font-bold">4.8/5 <span class="font-medium"> Rated.</span> <br>98%  <span class="font-medium">Recommend.</span></p>
          </div>
        </div>
      </div>
      <div>
        <div class="font-crossfit pt-[18px] text-[29px] leading-[31px] justify-center items-center text-center">
          <p class="text-white">Feel Calm, Clear, and<br> Energized by Day. <br><span class="text-[#370F1E]">Sleep Peacefully All Night.</span> </p>
        </div>
        <div class="flex pt-[24px] pb-[10px] gap-[5px] px-6">
          <svg class="" xmlns="http://www.w3.org/2000/svg" width="22" height="90" viewBox="0 0 19 81" fill="none">
            <path d="M8.99362 48.8975C9.33579 47.7402 10.0805 46.9211 10.9963 46.3914C11.0517 46.3603 11.0416 46.2846 10.9762 46.2712C8.7068 45.7104 6.11032 46.6897 5.18445 49.0088C4.72151 50.1661 4.89763 51.4659 5.65745 52.4897C7.17709 54.5507 9.96478 54.9602 12.0178 53.9364C12.0732 53.9097 12.0631 53.834 12.0027 53.8162C10.9712 53.4913 10.0252 52.8503 9.38108 51.7953C8.84266 50.9095 8.70177 49.8679 8.98859 48.8975H8.99362Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M9.71819 54.4927C12.3388 54.4927 14.4633 52.6134 14.4633 50.2951C14.4633 47.9769 12.3388 46.0975 9.71819 46.0975C7.09754 46.0975 4.97308 47.9769 4.97308 50.2951C4.97308 52.6134 7.09754 54.4927 9.71819 54.4927Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M12.9286 44.3215C12.8581 44.0455 12.4958 43.9164 12.2291 44.0633C11.4995 44.4683 10.6441 44.6998 9.71819 44.6998C8.79232 44.6998 7.93689 44.4639 7.20726 44.0633C6.93553 43.9119 6.57827 44.0455 6.50782 44.3215C6.31661 45.0604 5.89392 45.7637 5.24481 46.3424C4.59065 46.921 3.80064 47.2905 2.96031 47.4596C2.64833 47.522 2.5024 47.8425 2.66846 48.0784C3.12636 48.7238 3.38802 49.4805 3.38802 50.2996C3.38802 51.1186 3.12133 51.8754 2.66846 52.5208C2.49737 52.7612 2.64833 53.0772 2.96031 53.1395C3.79561 53.3087 4.59065 53.6826 5.24481 54.2568C5.89896 54.831 6.31661 55.5343 6.50782 56.2777C6.57827 56.5537 6.94057 56.6828 7.20726 56.5359C7.93689 56.1308 8.79232 55.8993 9.71819 55.8993C10.6441 55.8993 11.4995 56.1353 12.2291 56.5359C12.5008 56.6872 12.8581 56.5537 12.9286 56.2777C13.1198 55.5388 13.5425 54.8355 14.1916 54.2568C14.8407 53.6781 15.6357 53.3087 16.4761 53.1395C16.7881 53.0772 16.934 52.7567 16.7679 52.5208C16.31 51.8754 16.0484 51.1186 16.0484 50.2996C16.0484 49.4805 16.3151 48.7238 16.7679 48.0784C16.939 47.838 16.7881 47.522 16.4761 47.4596C15.6408 47.2905 14.8457 46.9166 14.1916 46.3424C13.5374 45.7637 13.1198 45.0648 12.9286 44.3215Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M7.79494 66L5.14311 74.5109C5.07769 74.7157 5.25381 74.916 5.49031 74.916H7.9308C8.1673 74.916 8.33839 75.1119 8.278 75.3166L7.09047 79.4074C6.99486 79.7368 7.46283 79.9505 7.71443 79.6923L14.2157 72.2319C14.417 72.0226 14.2509 71.7066 13.944 71.7066H11.3525C11.0808 71.7066 10.9047 71.4484 11.0355 71.2348L14.1452 66.4718C14.2761 66.2582 14.105 66 13.8282 66H7.79494Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M7.30681 78.6684C4.56944 77.8716 2.59692 75.5925 2.59692 72.9039C2.59692 70.2153 4.63989 67.8605 7.45274 67.0994" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M13.2496 67.8473C15.0963 68.9334 16.314 70.7941 16.314 72.904C16.314 76.2558 13.2446 78.9711 9.45551 78.9711C9.12844 78.9711 8.80639 78.9489 8.48938 78.9133" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            ...
            <path d="M8.88368 34.1788C12.6854 34.1788 15.7674 31.4525 15.7674 28.0894C15.7674 24.7263 12.6854 22 8.88368 22C5.08193 22 2 24.7263 2 28.0894C2 31.4525 5.08193 34.1788 8.88368 34.1788Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M12.2551 28.0896C12.5016 28.0896 12.6878 28.281 12.6576 28.4947C12.4312 30.1595 10.831 31.4504 8.88366 31.4504C6.9363 31.4504 5.33615 30.1595 5.10971 28.4947C5.07952 28.281 5.27073 28.0896 5.51227 28.0896H12.25H12.2551Z" stroke="white" stroke-width="0.79845" stroke-miterlimit="10"/>
            <path d="M8.11388 25.9706C7.81699 25.4988 7.25342 25.1738 6.59927 25.1738C5.94512 25.1738 5.38154 25.4988 5.08466 25.9706" stroke="white" stroke-width="0.79845" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M12.6879 25.9706C12.391 25.4988 11.8275 25.1738 11.1733 25.1738C10.5192 25.1738 9.95558 25.4988 9.65869 25.9706" stroke="white" stroke-width="0.79845" stroke-miterlimit="10" stroke-linecap="round"/>
          </svg>
          <ul class="text-[#370F1E] relative bottom-[3px] gap-[2px] text-[14px] leading-[22px] font-bold flex flex-col">
          <li><p >Stress, Anxiety & Exhaustion Relief </p></li>
          <li><p>Pain & Inflammation Relief</p></li>
          <li><p>Mood, Focus & Energy </p></li>
          <li><p>Calm by Day, Rest by Night </p></li>
        </ul>
        </div>
        <div class="px-6">
          <ShopButton type="button" id="buy-button" :anchorId="anchorId" textColorClass="text-[#370F1E]" :showIcon="false"
            class="botao-shop font-bold !m-0 text-[18px] w-full rounded-3xl text-center !h-[41px] !hover:bg-none !px-5 !pb-0 !bg-[#FFDC03] mt-[1.65rem]">
            Yes, I Want to Relax Now
          </ShopButton> 
        </div>
        <div class="px-6">
          <div class="w-[320px] mt-2 flex flex-row items-center justify-between px-5 lg:hidden">
            <div class="flex flex-row items-center gap-4 w-[200px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="26" viewBox="0 0 43 28" fill="none">
                    <path
                ...
                <div>
                    <span class="font-DMSans text-[13px] text-[#370F1E]">Free U.S. <br>Shipping</span>
                </div>
            </div>
            <div class="w-[1px] h-[42px] bg-[#370F1E]"></div>

            <div class="flex flex-row items-center justify-end gap-4 w-[200px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 33 48" fill="none">
                    <path
                ...
                <div>
                    <span class="font-DMSans text-[13px] text-[#370F1E] ">Money-Back<br>Guarantee</span>
                </div>
            </div>
          </div>
        </div>
