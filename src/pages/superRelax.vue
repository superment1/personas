    ...
    <div class="relative
      ...
      <div class="px-12">
        <div class="text-[#370F1E] gap-[120px] flex flex-col">
          <p class="italic font-gelasio mt-[60px] text-[13px] leading-[15px] font-bold">A Powerfull <br>Plant-Based
          ...
          <div class="font-gelasio">
            ...
            <p class="text-[13px] font-bold">4.8/5 <span class="font-medium"> Rated.</span> <br>98% <span
