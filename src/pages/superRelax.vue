  ...
  <section class="firtsection bg-[#6fc8f0]">
    <div class="relative
      ...
      <div class="w-full lg:w-[750px] pl-0 lg:pl-[7.5rem] pb-0 lg:pb-[36px]">
        <div class="px-12">
          <div class="text-[#370F1E] gap-[120px] lg:gap-[20px] flex flex-col">
            ...
            <div class="font-gelasio">
              <svg class="sm:hidden" xmlns="http://www.w3.org/2000/svg" width="69" height="17" viewBox="0 0 69 17" fill="none">
              ...
              <svg class="hidden sm:flex" xmlns="http://www.w3.org/2000/svg" width="112" height="27" viewBox="0 0 112 27" fill="none">
                <g filter="url(#filter0_d_198_867)">
                  <path d="M15.0039 1.53413C15.0053 1.53413 15.0066 1.53502 15.007 1.53635L15.8648 4.17975C16.3767 5.75718 17.8464 6.82537 19.5048 6.82537H22.2852C23.1764 6.82537 23.5497 7.96855 22.8265 8.49114C20.144 10.4418 19.0218 13.8984 20.0456 17.0533C20.3208 17.9025 19.3503 18.607 18.6271 18.0844C15.9454 16.1344 12.3127 16.1344 9.63103 18.0844C8.9078 18.607 7.93727 17.9025 8.21257 17.0533C9.23636 13.8984 8.11416 10.4418 5.43163 8.49114C4.7084 7.96855 5.08168 6.82537 5.97289 6.82537C9.2891 6.82537 12.2282 4.68841 13.2519 1.53413C13.5269 0.685667 14.7242 0.684914 15.0009 1.53187C15.0013 1.53319 15.0025 1.53413 15.0039 1.53413Z" fill="url(#paint0_linear_198_867)"/>
                  <path d="M35.877 1.53266C35.8784 1.53266 35.8796 1.53356 35.88 1.53488L36.7379 4.17829C37.2498 5.75571 38.7194 6.82391 40.3778 6.82391H43.1583C44.0495 6.82391 44.4228 7.96708 43.6995 8.48967C41.017 10.4403 39.8948 13.897 40.9186 17.0518C41.1939 17.901 40.2234 18.6056 39.5001 18.083C36.8185 16.1329 33.1857 16.1329 30.5041 18.083C29.7808 18.6056 28.8103 17.901 29.0856 17.0518C30.1094 13.897 28.9872 10.4403 26.3047 8.48967C25.5814 7.96708 25.9547 6.82391 26.8459 6.82391C30.1622 6.82391 33.1013 4.68695 34.1249 1.53266C34.3999 0.684202 35.5972 0.683449 35.8739 1.5304C35.8743 1.53173 35.8756 1.53266 35.877 1.53266Z" fill="url(#paint1_linear_198_867)"/>
                  <path d="M56.751 1.53266C56.7524 1.53266 56.7536 1.53356 56.7541 1.53488L57.6119 4.17829C58.1238 5.75571 59.5935 6.82391 61.2519 6.82391H64.0323C64.9235 6.82391 65.2968 7.96708 64.5736 8.48967C61.891 10.4403 60.7688 13.897 61.7926 17.0518C62.0679 17.901 61.0974 18.6056 60.3742 18.083C57.6925 16.1329 54.0598 16.1329 51.3781 18.083C50.6549 18.6056 49.6843 17.901 49.9596 17.0518C50.9834 13.897 49.8612 10.4403 47.1787 8.48967C46.4555 7.96708 46.8287 6.82391 47.72 6.82391C51.0362 6.82391 53.9753 4.68695 54.9989 1.53266C55.274 0.684202 56.4713 0.683449 56.7479 1.5304C56.7484 1.53173 56.7496 1.53266 56.751 1.53266Z" fill="url(#paint2_linear_198_867)"/>
                  <path d="M77.625 1.53266C77.6264 1.53266 77.6277 1.53356 77.6281 1.53488L78.4859 4.17829C78.9978 5.75571 80.4675 6.82391 82.1259 6.82391H84.9063C85.7975 6.82391 86.1708 7.96708 85.4476 8.48967C82.7651 10.4403 81.6429 13.897 82.6666 17.0518C82.9419 17.901 81.9714 18.6056 81.2482 18.083C78.5665 16.1329 74.9338 16.1329 72.2521 18.083C71.5289 18.6056 70.5584 17.901 70.8337 17.0518C71.8575 13.897 70.7352 10.4403 68.0527 8.48967C67.3295 7.96708 67.7028 6.82391 68.594 6.82391C71.9102 6.82391 74.8493 4.68695 75.8729 1.53266C76.148 0.684202 77.3453 0.683449 77.622 1.5304C77.6224 1.53173 77.6236 1.53266 77.625 1.53266Z" fill="url(#paint3_linear_198_867)"/>
                  <path d="M98.4971 1.53266C98.4985 1.53266 98.4997 1.53356 98.5002 1.53488L99.358 4.17829C99.8699 5.75571 101.34 6.82391 102.998 6.82391H105.778C106.67 6.82391 107.043 7.96708 106.32 8.48967C103.637 10.4403 102.515 13.897 103.539 17.0518C103.814 17.901 102.843 18.6056 102.12 18.083C99.4386 16.1329 95.8059 16.1329 93.1242 18.083C92.401 18.6056 91.4304 17.901 91.7057 17.0518C92.7295 13.897 91.6073 10.4403 88.9248 8.48967C88.2016 7.96708 88.5748 6.82391 89.466 6.82391C92.7823 6.82391 95.7214 4.68695 96.745 1.53266C97.0201 0.684202 98.2173 0.683449 98.494 1.5304C98.4945 1.53173 98.4957 1.53266 98.4971 1.53266Z" fill="url(#paint4_linear_198_867)"/>
                </g>
                <defs>
                  <filter id="filter0_d_198_867" x="0.740674" y="0.895752" width="110.27" height="25.9862" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                  ...
                  <linearGradient id="paint0_linear_198_867" x1="20.254" y1="16.9543" x2="10.2999" y2="1.51921" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFE5A6"/>
                    <stop offset="0.307692" stop-color="#E49C21"/>
                    <stop offset="0.697115" stop-color="#FFE5A6"/>
                    <stop offset="1" stop-color="#E49C21"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear_198_867" x1="41.127" y1="16.9528" x2="31.173" y2="1.51774" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFE5A6"/>
                    <stop offset="0.307692" stop-color="#E49C21"/>
                    <stop offset="0.697115" stop-color="#FFE5A6"/>
                    <stop offset="1" stop-color="#E49C21"/>
                  </linearGradient>
                  <linearGradient id="paint2_linear_198_867" x1="62.001" y1="16.9528" x2="52.047" y2="1.51774" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFE5A6"/>
                    <stop offset="0.307692" stop-color="#E49C21"/>
                    <stop offset="0.697115" stop-color="#FFE5A6"/>
                    <stop offset="1" stop-color="#E49C21"/>
                  </linearGradient>
                  <linearGradient id="paint3_linear_198_867" x1="82.8751" y1="16.9528" x2="72.921" y2="1.51774" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFE5A6"/>
                    <stop offset="0.307692" stop-color="#E49C21"/>
                    <stop offset="0.697115" stop-color="#FFE5A6"/>
                    <stop offset="1" stop-color="#E49C21"/>
                  </linearGradient>
                  <linearGradient id="paint4_linear_198_867" x1="103.747" y1="16.9528" x2="93.7931" y2="1.51774" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FFE5A6"/>
                    <stop offset="0.307692" stop-color="#E49C21"/>
                    <stop offset="0.697115" stop-color="#FFE5A6"/>
                    <stop offset="1" stop-color="#E49C21"/>
        ...
        <div>
        <div class="font-crossfit px-0 lg:px-12 pt-[18px] lg:pt-[62px] text-[29px] lg:text-[51px] leading-[31px] lg:leading-[57px] justify-center items-center text-center lg:text-start">
        ...
        <div class="flex flex-col px-6 lg:px-12">
          <div class="flex pt-[24px] pb-[10px] lg:pb-[22px] gap-[5px] ">
            ...
            <ul class="text-[#370F1E] relative bottom-[3px] gap-[2px] text-[14px] lg:text-[23px] leading-[22px] lg:leading-[30px] font-bold flex flex-col">
              <li>
        ...
        <div class="px-6">
          <div class="w-[320px] lg:w-[500px] justify-self-center lg:mt-8 mt-[12px] flex flex-row items-center justify-between px-5">
            <div class="flex flex-row items-center gap-4 w-[200px]">
              <svg class="lg:w-[60px] lg:h-[50px]" xmlns="http://www.w3.org/2000/svg" width="32" height="26" viewBox="0 0 43 28" fill="none">
                <path
            ...
            <div class="flex flex-row items-center justify-end gap-4 w-[200px] lg:w-[240px]">
              <svg class="lg:w-[50px] lg:h-[65px]" xmlns="http://www.w3.org/2000/svg" width="22" height="33" viewBox="0 0 33 48" fill="none">
                <path
    ...
    <div class="px-0 sm:px-10 flex flex-col gap-0 sm:gap-[40px]">
      <div class="w-full max-w-[330px] sm:max-w-[700px] mx-auto">
        <h1 class="text-center w-full sm:hidden pb-[30px] leading-none text-[#370F1E] text-[25px] font-bold font-gelasio italic">
          Frequently asked <br>
          questions:</h1>
        <h1 class="text-start hidden w-full sm:block pb-[30px] leading-none text-[#370F1E] text-[52px] font-bold  font-gelasio italic">
